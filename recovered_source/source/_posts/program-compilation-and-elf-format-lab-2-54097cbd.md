---
title: "Program-Compilation-and-ELF-Format-Lab-2"
date: "2024-04-02T02:49:56.000Z"
updated: "2024-04-02T03:10:50.529Z"
description: "常用分析工具。"
categories:
  - 逆向工程与汇编语言
tags:
...
<h1 id="task-1使用-file-解决类型问题">Task 1：使用 file 解决类型问题</h1>
<p>步骤：</p>
...
<h1 id="task-2使用-ldd-探索依赖性">Task 2：使用 ldd 探索依赖性</h1>
<p>步骤：</p>
...
<h1 id="task-3使用-xxd-查看文件内容">Task 3：使用 xxd 查看文件内容</h1>
<p>步骤：</p>
...
<h1 id="task-4使用-readelf-解析并提取-elf-库文件">Task 4：使用 readelf 解析并提取 ELF 库文件</h1>
<p>步骤：</p>
...
<h1 id="task-5使用-nm-解析符号">Task 5：使用 nm 解析符号</h1>
<p>步骤：</p>
...
<h1 id="task-6使用-strings-查找-hints">Task 6：使用 strings 查找 Hints</h1>
<p>步骤：</p>
...
<h1 id="task-7使用-strace-和-ltrace-跟踪系统调用和库文件调用">Task 7：使用 strace 和 ltrace 跟踪系统调用和库文件调用</h1>
<p>步骤：</p>
...
<h1 id="task-8使用-objdump-检查指令级别的行为">Task 8：使用 objdump 检查指令级别的行为</h1>
<p>步骤：</p>
...
<h1 id="task-9使用-gdb-转存动态字符串缓冲区">Task 9：使用 GDB 转存动态字符串缓冲区</h1>
<p>步骤：</p>
