---
title: "ELF-Code-Injection-Technology"
date: "2024-06-03T09:01:53.000Z"
updated: "2024-06-03T09:21:13.053Z"
description: "学习几种将代码注入现有 ELF 二进制文件的基本技术，从而允许修改或者扩展二进制文件的行为。"
categories:
  - 逆向工程与汇编语言
tags:
  - Linux
...
<h2 id="观察-off-by-one-漏洞">观察 off-by-one 漏洞</h2>
<p>步骤：</p>
...
<h2 id="修复-off-by-one-漏洞">修复 off-by-one 漏洞</h2>
<p>步骤：</p>
...
<h1 id="task-2使用-ld_preload-修改共享库行为">Task 2：使用 LD_PRELOAD 修改共享库行为</h1>
...
<h2 id="修复堆溢出漏洞">修复堆溢出漏洞</h2>
<p>输入 <code>LD_PRELOAD='pwd'/heapcheck.so ./heapoverflow 13 'perl -e 'print &quot;A&quot;x100''</code> 指令，在启动 heapoverflow 程序时，改变LD_PRELOAD 环境变量的定义，这使得链接器预加载指定的库文件 <a href="http://heapcheck.so">heapcheck.so</a>，成功检测到不安全的复制行为，输出错误，并安全地终止程序，因此程序没有崩溃。</p>
...
<h1 id="task-3注入代码节code-section">Task 3：注入代码节（Code Section）</h1>
<p>步骤：</p>
...
<h1 id="task-4调用注入的代码">Task 4：调用注入的代码</h1>
<h2 id="入口点修改">入口点修改</h2>
<p>步骤：</p>
...
<h2 id="劫持构造函数和析构函数">劫持构造函数和析构函数</h2>
<p>步骤：</p>
